...
replace (
	...
	github.com/scroll-tech/go-ethereum => github.com/morph-l2/go-ethereum v1.10.14-0.20240104112755-255c963a1539
	github.com/tendermint/tendermint => github.com/morph-l2/tendermint v0.0.0-20240104052747-fd21a40eb741
)
