...
replace (
	...
	github.com/scroll-tech/go-ethereum => github.com/bebop-labs/go-ethereum v1.10.14-0.20230426123059-f23e7baf2314
	github.com/tendermint/tendermint => github.com/bebop-labs/tendermint v0.0.0-20230426134729-7e1402f136b6
)
